...
$title = intval($model->id)>=1 ? "修改意见反馈" : "创建意见反馈";
            ...
            <div class="x_top_content">
		      ...
		      <h2 style="margin-top:5px;"><?= $title; ?></h2>	
                    ...
                    <div>
                        ...
                        <?php echo $form->field($model, 'system')->dropDownList($model->getSystem(), ['style' => 'width:200px']);  ?>
                        <?php echo $form->field($model, 'contact_type')->dropDownList($model->getContactType(), ['style' => 'width:200px']);  ?>
                        <?php echo $form->field($model, 'contact')->textInput(); ?>
                        <?php echo $form->field($model, 'content')->textArea(); ?>
                        <?php echo $form->field($model, 'handle_status')->dropDownList($model->getHandleStatus(), ['style' => 'width:200px']);  ?>
                        <?php echo $form->field($model, 'handle_remark')->textArea(); ?>
