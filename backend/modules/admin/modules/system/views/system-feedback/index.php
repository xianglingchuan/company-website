...
$this->title = '意见反馈管理-' . Yii::$app->setting->get('siteName');
    ...
    <div class="x_section">
        ...
        <div class="x_section_r">
            <div class="x_prompt" style="margin-top:15px;border-bottom:none">
                <h2 style="margin-top:5px;">意见反馈管理</h2>	
<!--                <div class="x_add_product"><?= Html::a('添加意见反馈', ['create']) ?></div>-->
            </div>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model){
                                   return  isset($model->user) && !empty($model->user) ? $model->user->getUserName() : "";
                                }
                            ], 
                            'version',
                            //'system',
                            [
                                'attribute' => 'system',
                                'value' => function ($model){
                                   return $model->getSystem($model->system);
                                }
                            ],                             
                            //'contact_type',
                            [
                                ...
                                'value' => function ($model){
                                   return $model->getContactType($model->contact_type);
                                }
                            ],                             
                            'contact',
                                    
                            [
                                'attribute' => 'handle_status',
                                'value' => function ($model){
                                   return $model->getHandleStatus($model->handle_status);
                                }
                            ], 
