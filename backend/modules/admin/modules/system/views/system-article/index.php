                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value'=>function($model){
                                      return isset($model->category) && !empty($model->category) ? $model->category->name : "暂无";     
                                }
                            ],
                            ...
                            /*[
                                ...
                                'format' => 'raw',
                                'value' => function($model) {
                                    return !empty($model->cover) ? Html::img($model->getCover(), ['style' => "width:100px; height:100px"]) : "";
                                }
                            ],*/
